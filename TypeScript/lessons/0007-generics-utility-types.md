...
- [x] ex14：三个签名自己推出（groupBy / chunk 的签名课件没给），探针赋值留在代码里 ✅ 2026-09-09
- [x] ex14：pluck 带约束 `K extends keyof T`，返回 `T[K][]` ✅ 2026-09-09
- [x] ex14：手滑实验报错原文留痕，实验行已注释回去 ✅ 2026-09-09
- [x] ex14：chunk 的 `n <= 0` 边界处理了 ✅ 2026-09-09
- [x] ex15：纸面展开两栏 + 与悬停对照 + 等价结论一句话 ✅ 2026-09-09
- [x] ex15：ex4 的 update 已换 `Partial<Pick<Contact, 'name' | 'phone'>>`；countByTag 计数正确、漏键报错留痕 ✅ 2026-09-09
- [x] 全程没写 `as` / `!`，命名 camelCase ✅ 2026-09-09
