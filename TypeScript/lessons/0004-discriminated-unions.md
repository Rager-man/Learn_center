...
- [x] ex7：Order 四变体只装各状态成立的字段；试着造过非法状态（手滑字面量 / 多余字段），确认被 TS2322 / TS2353 拦下 ✅ 2026-09-03
- [x] ex7：删 case 实验完成，报错原文已留痕（含错误码），恢复后 0 error ✅ 2026-09-03
- [x] ex7：非法流转被拒有演示，throw 被 try/catch 接住 ✅ 2026-09-03
- [x] ex8：`isOrderStatus` 签名是 `x is OrderStatus`，能说出它和返回 `boolean` 的区别 ✅ 2026-09-03
- [x] ex8：空串金额被拦——`Number("") === 0` 的坑补上了 ✅ 2026-09-03
- [x] ex8：全程没写 `as` / `!`，命名 camelCase ✅ 2026-09-03
- [x] 复查：守卫生效的范围内，没有再上多余的 `?.`（第 3 课回潮点，开场复查过的那条） ✅ 2026-09-03
