...
- [x] ex9：三段现象留痕齐全，TS2339 报错原文（含错误码）在案 ✅ 2026-09-05
- [x] ex9：实验代码注释回去，项目回到 0 error ✅ 2026-09-05
- [x] ex10：预测先写且未改；串行 ≈1600 / 并发 ≈800 ✅ 2026-09-05
- [x] ex10：思考题实测数字 + 一句结论（创建即启动）✅ 2026-09-05
- [x] ex11：`return await fn()` 的原因能说出来（catch 管辖范围）✅ 2026-09-05
- [x] ex11：明细经 `status` 窄化；失败理由经 `instanceof Error` 窄化 ✅ 2026-09-05
- [x] 全程没写 `as` / `!`，命名 camelCase ✅ 2026-09-05
